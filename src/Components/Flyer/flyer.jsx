...
const Flyer = () => {
  ...
  const handleEnquire = () => {
    navigate('/contact', {
      state: { selectedService: 'Flyer Design' }
    });
  };
  ...
  useEffect(() => {
    const fetchImages = async () => {
      try {
        ...
        const logoImages = data.filter(img => img.category === 'flyer');
  ...
  const fetchPackages = async () => {
    try {
      ...
      const flyerPackages = data.filter(pkg => pkg.category === 'flyer');

      // Limit the packages to 3 (Basic, Standard, Premium)
      setPackages(flyerPackages.slice(0, 3));
    } catch (error) {
  ...
  return (
    <div className='text'>
      ...
      <Container>
        <Row className="mb-5">
          <Col sm={12} md={6}>
            <div className="text-justify">
              <h4 className="fw-bold blue px-4 me-3 pb-2">Creative Flyer Design Company in India

              </h4>

              <div className="text-secondary text">
                <p>
                  Is your product packaging an extension of your brand or just tomorrow&rsquo;s garbage?
                ...
                <p>We make sure that the labels and graphics are applied, colors are chosen, fonts are selected, and images are implemented to help represent your brand&rsquo;s vision in detail.
                  Cooperate with us for innovative, world-class product packaging design!
                </p>


              </div>
              <Row className="text-secondary text">
                <p>Flyer Design for Various Industries</p>

                <Col>
                  <p>•	 Corporate flyers</p>
                  <p>•	    Communication flyers</p>
                  <p>•	   Travel & tourism flyers</p>
                  <p>•	   Education and academics flyers</p>
                  <p>•	    Agriculture flyers</p>

                </Col>
                <Col>
                  <p>•	   Startup Flyer</p>
                  <p>•	    Automobile flyers</p>
                  <p>•	    Company flyers</p>
                  <p>•	   Party flyers</p>
                  <p>•	    Entertainment flyers</p>

                </Col>
                <Col>
                  <p>•	    Business brochures</p>
                  <p>•	   Festival Offer flyers</p>
                  <p>•	    Engineering flyers</p>
                  <p>•	    Business flyers</p>
                  <p>•	    Real estate flyers</p>
          ...
          <Col xs={12} md={6} className="d-flex justify-content-center">
            <div className="curve">
              <img src={FlyerImage} className="p-5 rounded rounded-pill img-fluid" style={{ width: "500px", height: "500px" }} />
            </div>
          </Col>
        </Row>
        ...
        <Container>
          <div className="pt-5">
            <h3 className="text-center py-3 fw-bold mb-5">See Our Creative Flyer Design Work</h3>

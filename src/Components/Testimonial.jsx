    ...
    const fetchTestimonials = async () => {
      try {
        const res = await axios.get(
          "https://artisticify-backend.vercel.app/api/testimonials/fetchTestimonial"
        );
      ...
      <Container>
        <div className="text-center ">
          ...
          <p className="text-secondary mx-3 text">
            Our clients trust us to elevate their brands with powerful digital
            strategies. We’re proud to help businesses grow, connect, and

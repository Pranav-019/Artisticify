  ...
  const designServices = [
    {
      ...
      description:
        "We craft unique and memorable logos that truly reflect your brand’s identity and values, helping you stand out in the market and make a lasting first impression.",
      route: "/logo",
    },
    {
      id: 2,
      ...
      description:
        "Our brochure designs are tailored to highlight your business’s key offerings and deliver persuasive content with visual appeal, perfect for promotions and events.",
      route: "/Brochure",
    },
    {
      id: 3,
      ...
      description:
        "We design innovative and attractive packaging that not only protects your product but also boosts shelf appeal and enhances brand recognition.",
      route: "/Packaging",
    },
    {
      id: 4,
      ...
      description:
        "Catch attention instantly with our vibrant flyer designs that are strategically crafted to communicate your message and drive audience engagement.",
      route: "/Flyer",
    },
    {
      id: 5,
      ...
      description:
        "From promotional campaigns to events, our bold and impactful poster designs ensure your visuals command attention and leave a strong visual mark.",
      route: "/Poster",
    },
    {
      id: 6,
      ...
      description:
        "We create intuitive UI/UX designs that enhance user satisfaction by improving the usability, accessibility, and interaction of your digital product.",
      route: "/UIUX",
    },
    {
      id: 7,
      ...
      description:
        "Our responsive and modern website designs are tailored to your brand, offering visually engaging interfaces and seamless user experiences across all devices.",
      route: "/Websitedesign",
    },
    {
      id: 8,
      ...
      description:
        "Stylish and organized magazine layouts that engage readers and convey your content with visual flair.",
      route: "/Magazine",
    },
    {
      id: 9,
      ...
      description:
        "Informative and impactful visual aid designs ideal for presentations, pitches, and educational materials.",
      route: "/VisualAid",
    },
    {
      id: 10,
      ...
      description:
        "Custom-designed calendars that combine practicality with your brand’s aesthetic for daily visibility.",
      route: "/Calender",
    },
    {
      id: 11,
      ...
      description:
        "Crisp, modern icon sets tailored to suit apps, websites, and digital products for intuitive UI.",
      route: "/Icon",
    },
    {
      id: 12,
      ...
      description:
        "Build your professional identity with custom letterhead designs that reinforce brand consistency.",
    ...
    },
    {
      ...
      description:
        "Branded envelope designs perfect for correspondence, invitations, and official communication.",
    ...
    },
    {
      ...
      description:
        "Sleek and professional visiting cards designed to make a strong and memorable impression.",
    ...
    },
    {
      ...
      description:
        "Elegant certificates for awards, training programs, and events that mark achievement with class.",
    ...
    },
    {
      ...
      description:
        "Attractive and functional menu card designs tailored for cafes, restaurants, and food outlets.",
    ...
    <div style={{ backgroundColor: "#f0f9ff" }} className="py-5">
      ...
      <Container className="mt-5">
        <div className="text-center my-5">
          <h2 className="fw-bold" style={{ color: "#094167" }}>
            Creative Graphic Design & Digital Marketing Company in India
          </h2>
          <h4 className="py-3 fw-semibold d-flex justify-content-center text-center w-75 mx-auto">
            Unlock Creativity with Our Comprehensive Design & Digital Marketing
            Solutions—All Under One Roof!
          </h4>

          <p className="text-secondary text">
            From stunning web designs to impactful print materials and
            result-driven digital marketing strategies, we provide quality
            solutions tailored to elevate your brand. Since 2024, our expertise
            has spanned diverse industries, delivering innovative designs and
            strategic marketing campaigns that leave a lasting impression.
            Whether you need branding, marketing collateral, social media
            promotions, or digital assets, we ensure precision, creativity, and
            performance-driven results. Let’s bring your ideas to life with
            designs that captivate and marketing strategies that convert!
          </p>
        </div>
                  ...
                  {digitalMarketingServices.map((service) => (
                    ...
                    >
                      <div className="seo-success1 rounded">
                        <div
                          className="increse-visi1 p-5 text-dark"
                          id="text-block"
                        >

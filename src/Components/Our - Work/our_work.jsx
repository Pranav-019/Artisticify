    ...
    <div>
      ...
      <div className="d-flex justify-content-center align-items-center">
        <div className="text-center p-5 my-4 w-75">
          <h1 className="fw-bold extra-bold heading my-3">Graphic Design Packages</h1>
          <h4 className="blue my-3">Customizable Packages to Match Your Budget</h4>
          <p className="text-secondary pt-2">
            Our team of expert designers is dedicated to bringing your vision to life! Every design will be meticulously tailored to your exact requirements, ensuring 100% personal attention and a unique touch that meets your needs perfectly. Whether you have a small or large project, we offer flexible options that fit your budget and exceed your expectations!
            No matter the scope or scale, we promise high-quality results that align with your goals. Let us help you create something amazing that stands out!
          </p>
        </div>
      </div>
        ...
        <Row  className='mb-5 pb-5'>
          <Col md={6}>
            <div className='our-content px-5'>
              <h3 className='mb-3'   style={{ textShadow: '4px 4px 6px rgba(0, 0, 0, 0.4)' }}>{ourwork[0].h1}</h3>
              <p className='text-secondary'>{ourwork[0].p1}</p>
            </div>
          </Col>
          <Col md={6}>
          <Carousel fade interval={1000} className="custom-carousel" controls={false} indicators={false}>
      <Carousel.Item  style={{ boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.2)' }}>
        <img
          className="d-block our-img"
          src={logo} // Replace 'logo' with your actual image source
          alt="First slide"
        />
      ...
      <Carousel.Item  style={{ boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.2)' }}>
        <img
          className="d-block our-img"
          src={logo1} // Replace 'logo1' with your actual image source
          alt="Second slide"
        />
      ...
      <Carousel.Item>
        ...
        />
          ...
          <Col md={6}>
            <div className='our-content px-5'>
              <h3 className='mb-3'   style={{ textShadow: '4px 4px 6px rgba(0, 0, 0, 0.4)' }}>{ourwork[1].h2}</h3>
      ...
      <Container>
        ...
        <Row className='mb-5 pb-5'>
          <Col md={6}>
            <div className='our-content px-5'>
              <h3 className='mb-3'   style={{ textShadow: '4px 4px 6px rgba(0, 0, 0, 0.4)' }}>{ourwork[2].h3}</h3>
      ...
      <Carousel.Item>
        ...
        />
          ...
          <Col md={6}>
            <div className='our-content px-5'>
              <h3 className='mb-3'   style={{ textShadow: '4px 4px 6px rgba(0, 0, 0, 0.4)' }}>{ourwork[3].h4}</h3>
      ...
      <Container>
        ...
        <Row className='mb-5 pb-5'>
          <Col md={6}>
            <div className='our-content px-5'>
              <h3 className='mb-3'   style={{ textShadow: '4px 4px 6px rgba(0, 0, 0, 0.4)' }}>{ourwork[4].h5}</h3>
      ...
      <Carousel.Item>
        ...
        />
          ...
          <Col md={6}>
            <div className='our-content px-5'>
              <h3 className='mb-3'   style={{ textShadow: '4px 4px 6px rgba(0, 0, 0, 0.4)' }}>{ourwork[5].h6}</h3>
      ...
      <Container>
        ...
        <Row className='mb-5 pb-5'>
          <Col md={6}>
            <div className='our-content px-5'>
              <h3 className='mb-3'   style={{ textShadow: '4px 4px 6px rgba(0, 0, 0, 0.4)' }}>{ourwork[6].h7}</h3>
      ...
      <Carousel.Item>
        ...
        />
          ...
          <Col md={6}>
            <div className='our-content px-5'>
              <h3 className='mb-3'   style={{ textShadow: '4px 4px 6px rgba(0, 0, 0, 0.4)' }}>{ourwork[7].h8}</h3>
      ...
      <Container className=''>
        ...
        <Row className='mb-5 pb-5'>
          ...
          <Col md={6}>
            <div className='our-content px-5'>
              <h3 className='mb-3'   style={{ textShadow: '4px 4px 6px rgba(0, 0, 0, 0.4)' }}>{ourwork[8].h9}</h3>
      ...
      <Carousel.Item>
        ...
        />
          ...
          <Col md={6}>
            <div className='our-content px-5'>
              <h3 className='mb-3'   style={{ textShadow: '4px 4px 6px rgba(0, 0, 0, 0.4)' }}>{ourwork[9].h10}</h3>

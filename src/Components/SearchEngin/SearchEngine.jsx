...
function SearchEngine() {
  ...
  const fetchPackages = async () => {
    try {
      ...
      const searchenginePackages = data.filter(
        (pkg) => pkg.category === "searchengine"
      );
...
digital marketing and advertising agency."
      ...
      <h2 className="text-center fw-bold text-white my-5 shadow logo-package">
        Effective SEO solutions for better visibility, with premium options for
        extra impact.
      </h2>
      ...
      <Container>
          ...
          <Col sm={12} md={6} className="m-auto">
            <div className="text-justify ">
              ...
              <div className="text-secondary text">
                <p>
                  At Artisticify, we offer expert SEO services designed to help
                  your business rank higher in search engine results, drive
                  targeted traffic, and improve conversions. Our team uses a
                  combination of on-page and off-page SEO strategies, including:
                </p>

                <p>
                  We offer top-quality SEO services in India at affordable
                  rates, ensuring maximum value for your investment.
                  Specializing in both on-page and off-page SEO, we optimize
                  website content and implement strategic link-building to boost
                  search rankings. Our expertise in technical SEO sets us apart,
                  helping businesses attract search engine crawlers with
                  high-quality content. As a leading SEO provider, we deliver
                  result-driven strategies to enhance your online presence and
        ...
        <Container>
          <div className="">
            <h3 className="fw-bold text-center mt-5 mb-5">
              Rise to the Top – Proven SEO Strategies for Success!
            </h3>
            <Row className="">
                ...
                <div className="seo-success">
                  ...
                  <div className="increse-visi p-5 text-dark" id="text-block">
                    <div className="visibility ">
                      ...
                      <p className="mt-3">
                        We focus on ensuring your brand captures the attention
                        of your target audience at the perfect moment. Through
                        tailored strategies, we enhance engagement with your
                        posts and activities, making sure your brand stays
                        visible and connects with the right people.
                      </p>
                    </div>
                  </div>
                ...
                <div className="seo-success">
                  ...
                  <div className="increse-visi p-5 text-dark" id="text-block">
                    <div className="visibility ">
                      ...
                      <p className="mt-3">
                        See your business growth in real-time with our
                        transparent SEO services. We provide clear insights,
                        allowing you to track progress and understand how our
                        strategies are driving results for your brand.
                      </p>
                    </div>
                  </div>
                ...
                <div className="seo-success sm-mb-3">
                  ...
                  <div className="increse-visi p-5 text-dark" id="text-block">
                    <div className="visibility ">
                      ...
                      <p className="mt-3">
                        We don&rsquo;t make false promises! With our expert SEO
                        strategies, you can expect real, measurable results for
                        all your business promotions, ensuring your campaigns
                ...
                <div className="seo-success">
                  ...
                  <div className="increse-visi p-5 text-dark" id="text-block">
                    <div className="visibility ">
                      ...
                      <p className="mt-3">
                        Our strategic SEO services work to amplify your brand’s
                        presence. By strengthening your online identity, we help
                        convert your target audience into loyal, long-term
                        supporters, boosting brand recognition and trust.
                      </p>
                    </div>
                  </div>
        ...
        <Container>
          <div className="pt-5">
            <h3 className="text-center py-3 fw-bold">
              Why Choose a SEO Services?
            </h3>
            <p className="text-center w-75 d-flex justify-content-center mx-auto text-secondary mb-5">
              Effective SEO plays a crucial role in improving your online
              visibility. We ensure our strategies are tailored to boost your
              website&rsquo;s ranking while driving organic traffic. SEO remains
              a timeless and cost-effective solution, effectively promoting
              products, services, offers, and brand presence online.
            </p>
          </div>
        </Container>
        <Container>
          <Row>
            <div className="text-center">
              <h3 className="fw-bold">
                Boost Your Visibility and Attract Quality Traffic with Our
                Expert SEO Services
              </h3>
            </div>
              ...
              <div className="seo-success1">
                <div className="increse-visi1 p-5 text-dark" id="text-block">
                  <div className="visibility1 ">
                    ...
                    <p className="mt-3">
                      We conduct a comprehensive analysis of your website to
                      identify areas for improvement and develop strategic
                      action plans. Our detailed SEO reports help address
                      shortcomings, optimize performance, and drive your brand
                      toward its ultimate business goals.
                    </p>
                  </div>
                </div>
              ...
              <div className="seo-success1">
                <div className="increse-visi1 p-5 text-dark" id="text-block">
                  <div className="visibility1 ">
                    ...
                    <p className="mt-3">
                      Content is king in SEO! We optimize your website content
                      to engage visitors and align with search engine
                      algorithms, ensuring higher rankings on SERPs and
              ...
              <div className="seo-success1">
                <div className="increse-visi1 p-5 text-dark" id="text-block">
                  <div className="visibility1 ">
                    ...
                    <p className="mt-3">
                      Keyword research is the foundation of online success. We
                      identify the most relevant keywords, analyze search
                      volume, and optimize your website to drive maximum traffic
                      and business growth.
                    </p>
                  </div>
                </div>
              ...
              <div className="seo-success1">
                <div className="increse-visi1 p-5 text-dark" id="text-block">
                  <div className="visibility1 ">
                    <h4 className="mt-5 fw-bold">Desired Results</h4>
                    <p className="mt-3">
                      Our on-page SEO strategies optimize your website content,
                      meta titles, and more, while our off-page SEO services
                      focus on building high-quality backlinks. Together, these
                      approaches drive better rankings, increased traffic, and
                      long-term success.
                    </p>
                  </div>
                </div>
              ...
              <div className="seo-success1">
                <div className="increse-visi1 p-5 text-dark" id="text-block">
                  <div className="visibility1 ">
                    ...
                    <p className="mt-3">
                      To succeed in the market, you need to analyze your
                      competitors and strategically outrank them. Our in-depth
                      competitor analysis helps you stay ahead, ensuring your
              ...
              <div className="seo-success1">
                <div className="increse-visi1 p-5 text-dark" id="text-block">
                  <div className="visibility1 ">
                    ...
                    <p className="mt-3">
                      We optimize and manage your Google My Business listing to
                      align with your marketing goals. From services and offers
                      to engaging creatives, our GMB management helps enhance
                      your brand’s visibility and expand its global reach.
                    </p>
                  </div>
                </div>
                <div className="overlay1" />
              ...
              <div className="seo-success1">
                <div className="increse-visi1 p-5 text-dark" id="text-block">
                  <div className="visibility1 ">
                    ...
                    <p className="mt-3">
                      Get noticed locally with accurate and consistent NAP
                      (Name, Address, Phone Number) across all platforms. We
                      optimize your local citations to strengthen your SEO and
                      improve search rankings for better visibility.
                    </p>
                  </div>
                </div>
                <div className="overlay1" />
              ...
              <div className="seo-success1">
                <div className="increse-visi1 p-5 text-dark" id="text-block">
                  <div className="visibility1 ">
                    ...
                    <p className="mt-3">
                      As a leading SEO provider in Chennai, we help businesses
                      boost conversions through in-depth backlink analysis and
                      strategic link-building. Combined with smart content
                      marketing, our approach ensures strong SEO results and
                      higher rankings.
                    </p>
                  </div>
                </div>
              ...
              <div className="seo-success1">
                <div className="increse-visi1 p-5 text-dark" id="text-block">
                  <div className="visibility1 ">
                    ...
                    <p className="mt-3">
                      We provide comprehensive monthly reports, giving you clear
                      insights into your website’s performance. From backlink
                      analysis to content marketing strategies, our reports help
                      track progress and ensure your business achieves optimal
                      SEO results.
                    </p>
                  </div>
                </div>

...
const Icon = () => {
    ...
    useEffect(() => {
      const fetchImages = async () => {
        try {
          ...
          const logoImages = data.filter(img => img.category === 'icon');
  ...
  return (
    <div className='text'>
      <SEO title="Icon" description="Artisticify is a design company that provides design and Digital Marketing services to businesses." />
      <div className='about'>
